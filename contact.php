...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>@ParthPurohit | Connect </title>
        <!-- Favicon -->
...
<?php include_once('includes/header.php');?>
        ...
        My expertise extends to a wide range of technologies and frameworks, allowing me to adapt to diverse project requirements. I am dedicated to understanding the unique needs of each client and delivering tailored solutions that exceed expectations.<br>
        I welcome the opportunity to collaborate on projects, both large and small, and I am eager to contribute my skills and experience to help achieve your project goals. Let's work together to bring your vision to life.
        </div>
        <div class="contact">
            <div class="container">
